...
class appTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/servidor 2.2/wamp/www/Proyecto/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/servidor 2.2/wamp/www/Proyecto/app/Resources');
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager517848cc1980d_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager517848cc1980d_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/jms_diextra/doctrine/EntityManager_517848cc1980d.php';

        $a = $this->get('annotation_reader');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_163d1d3ca9905bc7098f4c348b99d012');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_163d1d3ca9905bc7098f4c348b99d012');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_163d1d3ca9905bc7098f4c348b99d012');
        ...
        $g->setProxyDir('D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager517848cc1980d_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($h, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/servidor 2.2/wamp/www/Proyecto/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '1de98e539716644392794c7e6552f1910');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/servidor 2.2/wamp/www/Proyecto/app/logs/test.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/assetic/routing.yml', array('cache_dir' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appTestUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appTestUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/servidor 2.2/wamp/www/Proyecto/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/servidor 2.2/wamp/www/Proyecto/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\servidor 2.2\\wamp\\www\\Proyecto\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
     ...
     *
     * @return EntityManager517848cc1980d_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/servidor 2.2/wamp/www/Proyecto/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'D:\\servidor 2.2\\wamp\\www\\Proyecto\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/servidor 2.2/wamp/www/Proyecto/app',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test',
            'kernel.logs_dir' => 'D:/servidor 2.2/wamp/www/Proyecto/app/logs',
            ...
            'debug.container.dump' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/appTestDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '1de98e539716644392794c7e6552f1910',
            ...
            'session.save_path' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'D:\\servidor 2.2\\wamp\\www\\Proyecto\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/profiler',
            ...
            'router.resource' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/assetic',
            ...
            'assetic.read_from' => 'D:/servidor 2.2/wamp/www/Proyecto/app/../web',
            'assetic.write_to' => 'D:/servidor 2.2/wamp/www/Proyecto/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/jms_diextra/doctrine/EntityManager_517848cc1980d.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager517848cc1980d_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'D:/servidor 2.2/wamp/www/Proyecto/app/cache/test/jms_security',
